...
- [`electric_teachers`](https://bowers-illinois-edu.github.io/CMRSS/reference/electric_teachers.md)
...
- [`get_default_solver()`](https://bowers-illinois-edu.github.io/CMRSS/reference/get_default_solver.md)
  : Get default solver
- [`method_berger_boos()`](https://bowers-illinois-edu.github.io/CMRSS/reference/method_berger_boos.md)
